...
namespace SIG_LaFamiliar.Forms.Estrategico
{
    public partial class FormRecuperacion : MaterialForm
    {
        ...
        {
            tblResultado.DataSource = DatosEstrategicos.recuperacion(dtpInicio.Value.Month + 44, dtpFinal.Value.Month + 44);
        }
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            Reportes.Reportes.ExcelDG(tblResultado, "Recuperación por nuevos planes de cobro");
            formEspera.Close();
        }
        ...
        private void btnWordDoc_Click(object sender, EventArgs e)
        {
            ...
            Reportes.Reportes.docGeneralEstrategico(tblResultado, "Recuperación por nuevos planes de cobro", dtpInicio.Value.Month + 44 + " " + dtpFinal.Value.Month + 44, Proveedor.usuario.nombre, 00, "word");
            formEspera.Close();
        }
        ...
        private void btnPDFDoc_Click(object sender, EventArgs e)
        {
            ...
            Reportes.Reportes.docGeneralEstrategico(tblResultado, "Recuperación por nuevos planes de cobro", dtpInicio.Value.Month + 44 + " " + dtpFinal.Value.Month + 44, Proveedor.usuario.nombre, 00, "pdf");
            formEspera.Close();
        }
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            Reportes.Reportes.docGeneralEstrategico(tblResultado, "Recuperación por nuevos planes de cobro", "Junio - 2014", "Juan", 123, "print");
            formEspera.Close();
        }
    }
}
